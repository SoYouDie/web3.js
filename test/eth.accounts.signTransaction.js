...
var tests = [
    {
        ...
        // signature from ess_signTransaction
    ...
    describe("accounts", function () {
        ...
        tests.forEach(function (test, i) {
            if (test.error) {
                ...
                it("signTransaction must compare to ess_signTransaction", function(done) {
                    var ethAccounts = new Accounts();
                ...
                it("signTransaction using the iban as \"to\" must compare to ess_signTransaction", function(done) {
                    var ethAccounts = new Accounts();
                ...
                it("signTransaction will call for nonce", function(done) {
                    ...
                    provider.injectValidation(function (payload) {
                        ...
                        assert.equal(payload.method, 'ess_getTransactionCount');
